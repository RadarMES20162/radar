...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChefeExecutivo.nome_completo'
        db.add_column('modelagem_chefeexecutivo', 'nome_completo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChefeExecutivo.nome_completo'
        db.delete_column('modelagem_chefeexecutivo', 'nome_completo')
    ...
    models = {
        ...
        'modelagem.chefeexecutivo': {
            ...
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'nome_completo': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
